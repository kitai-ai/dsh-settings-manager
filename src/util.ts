...
export function profileNameFromArgv(argv: string[] = process.argv): string {
...
export function profileDir(home: string = resolveDshHome(), profile: string = profileNameFromArgv()): string {
...
export function queryParam(url: string | undefined, name: string): string | undefined {
